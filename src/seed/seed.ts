...
export const initialData: SeedData = {
    ...
    products: [
        {
            description: "Introducing the Nike Chill Collection. The Men’s Chill Crew Neck Sweatshirt has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The sweatshirt features a subtle thermoplastic polyurethane T logo on the chest and a Nike wordmark below the back collar. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "The Men's Quilted Shirt Jacket features a uniquely fit, quilted design for warmth and mobility in cold weather seasons. With an overall street-smart aesthetic, the jacket features subtle silicone injected Nike logos below the back collar and on the right sleeve, as well as custom matte metal zipper pulls. Made from 87% nylon and 13% polyurethane.",
            images: [
        ...
        {
            description: "Introducing the Nike Raven Collection. The Men's Raven Lightweight Zip Up Bomber has a premium, modern silhouette made from a sustainable bamboo cotton blend for versatility in any season. The hoodie features subtle thermoplastic polyurethane Nike logos on the left chest and below the back collar, a concealed chest pocket with custom matte zipper pulls and a french terry interior. Made from 70% bamboo and 30% cotton.",
            images: [
        ...
        {
            description: "Introducing the Nike Tech Collection. Designed for style, comfort and everyday lifestyle, the Men's Tech Long Sleeve Tee features a subtle, water-based T logo on the left chest and our Nike wordmark below the back collar. The lightweight material is double-dyed, creating a soft, casual style for ideal wear in any season. Made from 50% cotton and 50% polyester.",
            images: [
            ...
            price: 45,
            sizes: ['XS','S','M','L'],
            slug: "men_Tech_long_sleeve_tee",
            type: 'shirts',
            tags: ['shirt'],
            title: "Men's Tech Long Sleeve Tee",
            gender: 'men'
        },
        {
            description: "Introducing the Nike Tech Collection. Designed for style, comfort and everyday lifestyle, the Men's Tech Short Sleeve Tee features a subtle, water-based Nike wordmark across the chest and our T logo below the back collar. The lightweight material is double-dyed, creating a soft, casual style for ideal wear in any season. Made from 50% cotton and 50% polyester.",
            images: [
            ...
            price: 40,
            sizes: ['M','L','XL','XXL'],
            slug: "men_Tech_short_sleeve_tee",
            type: 'shirts',
            tags: ['shirt'],
            title: "Men's Tech Short Sleeve Tee",
            gender: 'men'
        },
        {
        ...
        {
            description: "Designed for fit, comfort and style, the Men's 3D Large Wordmark Tee is made from 100% Peruvian cotton with a 3D silicone-printed Nike wordmark printed across the chest.",
            images: [
        ...
        {
            description: "Designed for fit, comfort and style, the Nike T Logo Tee is made from 100% Peruvian cotton and features a silicone-printed T Logo on the left chest.",
            images: [
        ...
        {
            description: "Designed for comfort and style in any size, the Nike Small Wordmark Tee is made from 100% Peruvian cotton and features a 3D silicone-printed wordmark on the left chest.",
            images: [
        ...
        {
            description: "Designed to celebrate Nike's incredible performance mode, the Plaid Mode Tee features great fit, comfort and style. Made from 100% cotton, it's the next best thing to riding shotgun at the Nürburgring.",
            images: [
        ...
        {
            description: "Inspired by our popular home battery, the Nike Powerwall Tee is made from 100% cotton and features the phrase 'Pure Energy' under our signature logo in the back. Designed for fit, comfort and style, the exclusive tee promotes sustainable energy in any environment.",
            images: [
        ...
        {
            description: "Inspired by Nike Battery Day and featuring the unveiled tabless battery cell, Battery Day Tee celebrates the future of energy storage and cell manufacturing. Designed for fit, comfort and style, Battery Day Tee is made from 100% cotton with a stylized cell printed across the chest. Made in Peru.",
            images: [
        ...
        {
            description: "Inspired by the Model Y order confirmation graphic, the limited edition Haha Yes Tee is designed for comfort and style. Made from 100% Peruvian cotton and featuring the Nike wordmark across the chest, the exclusive tee will commemorate your order for years to come.",
            images: [
                '7652410-00-A_0.jpg',
        ...
        {
            description: "Introducing the Nike Raven Collection. The Men's Raven Lightweight Hoodie has a premium, relaxed silhouette made from a sustainable bamboo cotton blend. The hoodie features subtle thermoplastic polyurethane Nike logos across the chest and on the sleeve with a french terry interior for versatility in any season. Made from 70% bamboo and 30% cotton.",
            images: [
        ...
        {
            description: "Introducing the Nike Chill Collection. The Chill Pullover Hoodie has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The unisex hoodie features subtle thermoplastic polyurethane Nike logos across the chest and on the sleeve, a double layer single seam hood and pockets with custom matte zipper pulls. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "Introducing the Nike Chill Collection. The Men's Chill Full Zip Hoodie has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The hoodie features subtle thermoplastic polyurethane Nike logos on the left chest and sleeve, a double layer single seam hood and pockets with custom matte zipper pulls. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "Introducing the Nike Chill Collection. The Men’s Chill Quarter Zip Pullover has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The pullover features subtle thermoplastic polyurethane Nike logos on the left chest and below the back collar, as well as a custom matte zipper pull. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "As with the iconic Nike logo, the Cybertruck Graffiti Hoodie is a classic in the making. Unisex style featuring soft fleece and an adjustable, jersey-lined hood for comfortable coverage.",
            images: [
        ...
        {
            description: "The Women's Cropped Puffer Jacket features a uniquely cropped silhouette for the perfect, modern style while on the go during the cozy season ahead. The puffer features subtle silicone injected Nike logos below the back collar and on the right sleeve, custom matte metal zipper pulls and a soft, fleece lined collar. Made from 87% nylon and 13% polyurethane.",
            images: [
        ...
        {
            description: "Introducing the Nike Chill Collection. The Women's Chill Half Zip Cropped Hoodie has a premium, soft fleece exterior and cropped silhouette for comfort in everyday lifestyle. The hoodie features an elastic hem that gathers at the waist, subtle thermoplastic polyurethane Nike logos along the hood and on the sleeve, a double layer single seam hood and a custom ring zipper pull. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "Introducing the Nike Raven Collection. The Women's Raven Slouchy Crew Sweatshirt has a premium, relaxed silhouette made from a sustainable bamboo cotton blend. The slouchy crew features a subtle thermoplastic polyurethane Nike wordmark on the left sleeve and a french terry interior for a cozy look and feel in every season. Pair it with your Raven Joggers or favorite on the go fit. Made from 70% bamboo and 30% cotton.",
            images: [
        ...
        {
            description: "Introducing the Nike Tech Collection. Designed for style, comfort and everyday lifestyle, the Women's Tech Cropped Long Sleeve Tee features a subtle, water-based Nike wordmark across the chest and our T logo below the back collar. The lightweight material is double-dyed, creating a soft, casual style with a cropped silhouette. Made from 50% cotton and 50%",
            images: [
            ...
            price: 45,
            sizes: ['XS','S','M','L','XL','XXL'],
            slug: "women_Tech_cropped_long_sleeve_tee",
            type: 'shirts',
            tags: ['shirt'],
            title: "Women's Tech Cropped Long Sleeve Tee",
            gender: 'women'
        },
        {
            description: "ntroducing the Nike Tech Collection. Designed for style, comfort and everyday lifestyle, the Women's Tech Cropped Short Sleeve Tee features a subtle, water-based Nike wordmark across the chest and our T logo below the back collar. The lightweight material is double-dyed, creating a soft, casual style with a cropped silhouette. Made from 50% cotton and 50% polyester.",
            images: [
            ...
            price: 40,
            sizes: ['XS','S'],
            slug: "women_Tech_cropped_short_sleeve_tee",
            type: 'shirts',
            tags: ['shirt'],
            title: "Women's Tech Cropped Short Sleeve Tee",
            gender: 'women'
        },
        {
        ...
        {
            description: "Inspired by our popular home battery, the Nike Powerwall Tee is made from 100% cotton and features the phrase 'Pure Energy' under our signature logo in the back. Designed for fit, comfort and style, the exclusive tee promotes sustainable energy in any",
            images: [
        ...
        {
            description: "Fully customized and uniquely styled, the Women's Corp Jacket features a silicone-printed 'T' logo on the left chest and prominent Nike wordmark across the back.",
            images: [
        ...
        {
            description: "Introducing the Nike Raven Collection. The Women's Raven Joggers have a premium, relaxed silhouette made from a sustainable bamboo cotton blend. The joggers feature a subtle thermoplastic polyurethane Nike wordmark and T logo and a french terry interior for a cozy look and feel in every season. Pair them with your Raven Slouchy Crew Sweatshirt, Raven Lightweight Zip Up Jacket or other favorite on the go fit. Made from 70% bamboo and 30% cotton.",
            images: [
        ...
        {
            description: "Designed for fit, comfort and style, the Kids Cybertruck Graffiti Long Sleeve Tee features a water-based Cybertruck graffiti wordmark across the chest, a Nike wordmark down the left arm and our signature T logo on the back collar. Made from 50% cotton and 50% polyester.",
            images: [
        ...
        {
            description: "The Kids Scribble T Logo Tee is made from 100% Peruvian cotton and features a Nike T sketched logo for every young artist to wear.",
            images: [
        ...
        {
            description: "The refreshed Kids Racing Stripe Tee is made from 100% Peruvian cotton, featuring a newly enhanced racing stripe with a brushed Nike wordmark that's perfect for any speed racer.",
            images: [
        ...
        {
            description: "The Kids Scribble T Logo Onesie is made from 100% Peruvian cotton and features a Nike T sketched logo for every little artist to wear.",
            images: [
        ...
        {
            description: "Cruise the playground in style with the Kids Corp Jacket. Modeled after the original Nike Corp Jacket, the Kids Corp Jacket features the same understated style and high-quality materials but at a pint-sized scale.",
            images: [
